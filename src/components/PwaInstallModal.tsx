          ...
          <div className="relative bg-gradient-to-br from-[#143e2e] via-[#0d2a1f] to-[#07110c] p-6 text-white overflow-hidden">
            ...
            <div className="flex items-center gap-3 mb-3">
              <img 
                ...
                className="w-12 h-12 rounded-2xl object-cover border border-white/20 shadow-lg shrink-0" 
              />
              <div>
                <span className="text-[10px] font-black uppercase tracking-widest bg-emerald-500/20 text-emerald-300 px-2 py-0.5 rounded-full border border-emerald-500/30 inline-block mb-1">
                  Official Mobile Web App
                </span>
                <h3 className="text-lg font-bold tracking-tight leading-tight">Tejas Rice</h3>
              </div>
            </div>

            <p className="text-xs text-slate-300 leading-relaxed">
              Add to Home Screen for one-tap direct access with the official Tejas Canvassing company icon & notch-safe full-screen experience.
            </p>
          </div>
