          ...
          <>
            ...
            >
              ...
              <div className="relative p-5 pb-4 border-b border-slate-200/80 dark:border-emerald-950/60 bg-gradient-to-br from-emerald-900/[0.06] via-transparent to-teal-900/[0.04] dark:from-emerald-950/50 dark:to-transparent">
                ...
                <div className="grid grid-cols-2 gap-2 mt-4 pt-3 border-t border-slate-200/60 dark:border-emerald-950/40">
                  <div className="bg-white dark:bg-[#0a1b14] border border-slate-200/70 dark:border-emerald-950/70 rounded-xl p-2.5 text-left">
                          ...
                          onClick={async () => {
                            ...
                            try {
                              ...
                              const updatedStakeholder = {
                                id: currentUid,
                                name: profName.trim() || 'Authorized Merchant',
                                type: 'buyers',
...
function MerchantBottomBar() {
  ...
  return (
    <div className="fixed bottom-[calc(0.875rem+env(safe-area-inset-bottom,0px))] sm:bottom-4 inset-x-0 z-40 flex justify-center px-3 sm:px-4 pointer-events-none">
      <nav 
      ...
      >
        ...
        <button
          ...
          className={cn(
            "flex flex-col items-center gap-0.5 rounded-full transition-all cursor-pointer border-0 outline-none active:scale-95 select-none",
            (location.pathname === '/my-orders' || location.pathname === '/placed-orders')
              ? "bg-[#143e2e] dark:bg-emerald-500/25 text-white dark:text-emerald-200 font-bold shadow-xs py-1.5 px-3.5 scale-105" 
              : "bg-transparent text-slate-400 dark:text-slate-500 hover:text-slate-600 dark:hover:text-slate-300 font-medium py-1.5 px-2.5"
          )}
        >
        ...
        <button
          ...
          onClick={() => navigate('/bag')}
          className={cn(
            "flex flex-col items-center gap-0.5 rounded-full relative transition-all cursor-pointer border-0 outline-none active:scale-95 select-none",
            location.pathname === '/bag' || location.pathname === '/cart'
              ? "bg-[#143e2e] dark:bg-emerald-500/25 text-white dark:text-emerald-200 font-bold shadow-xs py-1.5 px-3.5 scale-105" 
              : "bg-transparent text-slate-400 dark:text-slate-500 hover:text-slate-600 dark:hover:text-slate-300 font-medium py-1.5 px-2.5"
          )}
        >
...
function EmployeeHeader() {
  ...
  return (
    <header className="sticky top-0 z-40 bg-white/90 dark:bg-[#07130e]/90 backdrop-blur-md border-b border-slate-200/80 dark:border-neutral-800 pt-[env(safe-area-inset-top,0px)] shadow-2xs">
  ...
  return (
    ...
    >
      ...
      <div className="fixed inset-0 pointer-events-none z-0 overflow-hidden">
        <div className="absolute -top-40 -right-40 w-[600px] h-[600px] rounded-full bg-gradient-to-br from-amber-400/10 to-emerald-400/5 dark:from-amber-400/5 dark:to-emerald-500/5 blur-3xl opacity-70" />
        <div className="absolute top-1/3 -left-40 w-[500px] h-[500px] rounded-full bg-gradient-to-tr from-emerald-500/8 to-amber-300/5 dark:from-emerald-500/5 dark:to-transparent blur-3xl opacity-60" />
      </div>
      ...
      {!isSidebarCollapsed && (
        <div 
          className="md:hidden fixed inset-0 bg-black/40 backdrop-blur-xs z-50 transition-opacity cursor-pointer"
