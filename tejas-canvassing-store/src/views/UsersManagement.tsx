  ...
  const handleUpdateUser = (e: React.FormEvent) => {
    ...
    const userToSave = {
      ...
      ...(isEmployee ? {
        ...
        password: (selectedUser.password || '').trim() || 'emp1977',
                          ...
                          <div className="flex justify-between items-center">
                            ...
                            <div className="flex items-center gap-1.5">
                              <span className="font-mono font-bold text-on-surface">
                                {showEmployeePassword ? (selectedUser.password || 'emp1977') : '••••••••'}
                              </span>
                              <button
                                type="button"
                              ...
                              >
                                {showEmployeePassword ? <EyeOff className="w-3.5 h-3.5" /> : <Eye className="w-3.5 h-3.5" />}
                              </button>
                            </div>
                          </div>
